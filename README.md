...
2. [**実践Haskell**](docs/practical-haskell.md)
    ...
    3.  [Web](docs/web.md)
    4.  [分散型台帳技術](docs/distributed-ledger-technology.md)
    5.  [データベース](docs/database.md)
    6.  [暗号技術](docs/cryptography.md)
    7.  [Graphics/Game](docs/graphics.md)
    8.  [IoT/Mobile](docs/mobile.md)
    9.  [機械学習](docs/machine-learning.md)
    10. [量子コンピュータ](docs/quantum-computing.md)
