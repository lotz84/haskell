...
1. **Haskell: 純粋関数型プログラミング言語**
    ...
    6.  [型クラス](docs/type-class-and-abstraction.md)
    7.  [Functor, Applicative, Monad](docs/functor-applicative-monad.md)
    8.  [継続](docs/continuation.md)
    9.  [Lens](docs/lens.md)
    10. [Free Monad](docs/free-monad.md)
    11. [例外処理・デバッグ・テスト](docs/test-and-debug.md)
    12. [構文解析器](docs/parser.md)
    13. [Monad Transformer](docs/monad-transformers.md)
    14. [Algebraic Effects](docs/algebraic-effects.md)
    ...
    20. [Template Haskell](docs/template-haskell.md)
    21. [GHCと最適化](docs/ghc.md)
